...
Поддерживается несколько режимов работы, переключение нажатиями по тачпада DualSene и DualShock 4 или кнопками `Capture`, и `Home` для Pro контроллера, и Джойконов.

![](https://github.com/user-attachments/assets/c919479b-b320-4f0b-9bc0-9be3b4dd8661)
...
Сброс чувствительности | `PS + RS` | `Capture + RS` | -
Изменение силы вибрации или её отключение | `PS + Options` | `Capture + Плюс` | `ALT + </>`
Выключение и включение нажатия тачпада для переключения режимов | `PS + Share` | - | `ALT + W`
...
Выключение подсветки Sony | `PS + L1` или 2 раза нажмите на область яркости тапада и проведите пальцем влево или вправо. Если изменение яркости заблокировано `LockChangeBrightness`, то подсветка будет выключаться по двойному клику. | `HOME + L1` | `ALT + I`
